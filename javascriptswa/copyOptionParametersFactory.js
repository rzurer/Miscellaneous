"use strict";
define(['common', 'htmlHelper'], function (common, htmlHelper) {
    var addCellTitle = function (cell, title, titlePrefix) {
        ...
        createOptionContractParametersTableRow = function (element) {
            ...
            var jsonDate = common.parseJsonDate(element.OptionExpiration);
            var expirationDate = jsonDate.getMonth() + 1 + '-' + jsonDate.getDate() + '-' + jsonDate.getFullYear();
            cell = htmlHelper.appendCell(row, expirationDate);
